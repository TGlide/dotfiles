...
status is-interactive; and begin
    ...
    alias gs 'git status'
    alias ngoose 'nix-shell -p uv --run '\''goose session'\'''
    alias nv nvim
    alias yay paru
    ...
    export NIX_LD=$(nix eval --impure --raw --expr 'let pkgs = import <nixpkgs> {}; NIX_LD = pkgs.lib.fileContents "/nix/store/mzfk1sdv6bxvdh9slvddpj734ck99idi-gcc-wrapper-13.3.0/nix-support/dynamic-linker"; in NIX_LD ')
    ...
    if test "$TERM" != dumb
        eval (/home/thomasgl/.nix-profile/bin/starship init fish)
